...
class WindowsApiEmitter(EventEmitter):
    ...
    def __init__(self, event_queue, watch, parent_observer, timeout=DEFAULT_EMITTER_TIMEOUT):
        #print("#####windowsAPIEmitter init called")
        #print("   and it has parent - " + str(parent_observer))
    ...
    def on_thread_start(self):
        #print("Emitter's on_thread start" + str(self))
    ...
    def queue_events(self, timeout):
        print(self._handle)
        print("queue events called" +str(self))
        winapi_events = read_events(self,self._handle, self.watch.is_recursive)
        with self._lock:
